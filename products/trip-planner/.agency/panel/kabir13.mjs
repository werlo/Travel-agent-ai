...
await p.locator('input').nth(2).fill('7')
await p.waitForTimeout(300)
await p.screenshot({ path: '.agency/screenshots/12-adults-changed.png', fullPage: true })
await p.getByRole('button', { name: 'Update plan' }).click()
await p.waitForTimeout(2000)
console.log(await p.locator('body').innerText())
await p.screenshot({ path: '.agency/screenshots/13-after-update-7.png', fullPage: true })
await b.close()
