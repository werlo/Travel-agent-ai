...
await p.fill('#adjust-travellers', '12'); await p.waitForTimeout(300)
await p.getByRole('button', { name: /Update plan/i }).click(); await p.waitForTimeout(1200)
const txt = await p.locator('body').innerText()
console.log(txt.split('Your days')[0])
console.log('...')
console.log(txt.split('What makes up your')[1]?.split('Other ways')[0])
console.log('--- ALT ---')
console.log(txt.split('Other ways to do this')[1])
await p.screenshot({ path: '.agency/screenshots/kabir-15-twelve.png', fullPage: true })
await b.close()
