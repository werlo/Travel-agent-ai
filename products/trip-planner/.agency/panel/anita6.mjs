...
await p.locator('h1').click() // click away
await p.waitForTimeout(500)
...
await p.screenshot({ path: '.agency/screenshots/06-clicked-away.png', fullPage: true })

// try continue
const contBtn = p.getByRole('button', { name: 'Continue' })
await contBtn.click()
await p.waitForTimeout(1000)
console.log('--- after continue ---')
console.log(await p.locator('body').innerText())
await p.screenshot({ path: '.agency/screenshots/07-after-continue.png', fullPage: true })
await b.close()
