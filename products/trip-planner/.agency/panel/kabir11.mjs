...
const btns = await p.evaluate(()=>[...document.querySelectorAll('button,a,summary,[role=button]')].map(e=>e.tagName+': '+(e.innerText||'').replace(/\n/g,' / ').slice(0,70)))
console.log('INTERACTIVE:', JSON.stringify(btns, null, 1))
await b.close()
