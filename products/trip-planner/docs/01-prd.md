...
| **S2 — Trip basics** | Dates, budget, travellers, departure city, with inline validation and a running summary bar. | R2, R3, R16 |
...
| **S5 — Plan** | The itinerary, cost breakdown, budget line, "Why this trip", alternatives, adjust panel, relaxation banner, provenance. | R7, R8, R9, R10, R11, R12, R13, R14, R15, R16 |
